//NONE OF THIS CODE IS VALID but has been instrumental for me learning the ins and outs of API call handling
...
export async function getDOW(date){
  ...
  let start_date = (moment(date.date).subtract(8,"days").format('YYYY-MM-DD'))
  ...
  console.log(data.data.data.slice(-1)[0].open)
  return data;
};
